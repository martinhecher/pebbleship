//
// Description:
// Contains the placement logic for ships on the grid. It contains a metadata structure that keeps track
// of the free blocks in the grid for the horizontal and the vertical lines to make the placement efficient.
//
var PlacementLogic = module.exports = function(grid, config) {
  this.grid = grid;
...
PlacementLogic.prototype.initializeFreeLines = function(grid, config, vertical) {
  var metadata = [],
...
PlacementLogic.prototype.placeShip = function(ship) {
  //
  ...
  if (!candidateLines.length) {
    ...
    // handled here instead of simply bailing out! For this demo I leave it with
...
PlacementLogic.prototype.fitShipIntoFreeBlock = function(config, blocks, seed) {
...
PlacementLogic.prototype.getFreeLinesFor = function(ship, freeMetadata) {
...
PlacementLogic.prototype.updateFreeLinesMetadata = function(affectedLines, vertical) {
